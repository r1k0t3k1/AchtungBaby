...
REG ADD "HKCU\Software\Classes\CLSID\{5c8e9579-53b9-5a69-6a75-2d232518df35}\InprocServer32" /ve /t REG_SZ /d "C:\Users\tiwasa\AchtungBaby\target\debug\AchtungBaby.dll" /f
